...
namespace SGBank.Tests
{
    ...
    public class FreeAccountTests
    {
        ...
        [Test]
        public void CanNotLoadNonExistentFreeAccountTestData()
        {
            AccountManager manager = AccountManagerFactory.Create();

            AccountLookupResponse response = manager.LookupAccount("999999");

            Assert.IsFalse(response.Success);
        }

        [TestCase("12366", "Free Account", 100, AccountType.Free, 250, false)]
